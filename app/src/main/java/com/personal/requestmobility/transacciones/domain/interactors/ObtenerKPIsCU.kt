...
class ObtenerKPIsCU(private val repoTransacciones: IRepoTransacciones) {
    ...
    private suspend fun dameEjemploKPI_0(): Kpi {
        ...
        kpi.resultadoSQL = ResultadoSQL.from(repoTransacciones.ejecutarSQL(kpi.sql))
        return kpi
    }
    private suspend fun dameEjemploKPI_1(): Kpi {
        val kpi = Kpi(
            nombre = "Transacciones realizadas (01)",
    ...
    private suspend fun dameEjemploKPI_2(): Kpi {
        val kpi = Kpi(
            nombre = "Transacciones erroreneas (02)",
