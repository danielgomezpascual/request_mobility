...
fun MA_FilaTablaDatos(
        ...
        val ajustarContenidoAncho =
                if (configuracion.textoCeldaHorizontal) false
                else logicaAjusteCeldaAncho(nuemroCeldas, configuracion.ajustarContenidoAncho)
        ...
        Row(
                modifier =
                        modifier.background(if3(fila.seleccionada, color, colorFondo))
                                .then(
                                        if (configuracion.textoCeldaHorizontal)
                                                Modifier.width(
                                                        fila.celdas.fold(0.dp) { acc: Dp, d: Celda
                                                                ->
                                                                acc + d.size
                                                        }
                                                )
                                ...
                                if (indicadorColor && indice == 0) {
                                        ...
                                        Row(modifier = modifierCelda) {
                                                ...
                                                MA_LabelCelda(
                                                        celda.valor,
                                                        textoCompleto =
                                                                configuracion.textoCeldaCompleto,
                                                        horizontal =
                                                                configuracion.textoCeldaHorizontal
                                                )
                                        }
