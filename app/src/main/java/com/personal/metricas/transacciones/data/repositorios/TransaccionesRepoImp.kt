...
class TransaccionesRepoImp (fuentesDatos: List<IDataSourceTransacciones>):
    ...
    override suspend fun obtenerTransaccionesPorOrganizacion(organizacion: String): List<Transacciones>  = dameDS(TIPO_DS.RETROFIT).getAll(organizacion =  organizacion)
