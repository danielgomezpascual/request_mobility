		...
		dialog.sino("¿Seguro que desea generar la inicilizacion de metricas? Cualquier modificación relizada sobre estos elementos será descartada", onResultadoDialog = { resultado ->
			if (resultado == DialogosResultado.Si) {
				viewModelScope.launch {
					...
					//val organizaciones =listOf<String>("AAS",	"ABM",	"AFM",	"AGS",	"AMS",	"ATS",	"AVS",	"AZS",	"BCM",	"BEM",	"BGA",	"BHS",	"BKM",	"BLS",	"BMP",	"BOM",	"BPS",	"BSA",	"CBM",	"CTS",	"CVM",	"DBS",	"DEM",	"DFM",	"DGM",	"DHS",	"DNS",	"DRM",	"DSM",	"DTS",	"DWS",	"EAL",	"EAS",	"ECA",	"EDL",	"EFG",	"EFP",	"EGE",	"EGM",	"EGR",	"ELE",	"EMX",	"GAM",	"GH0",	"GTS",	"MAM",	"MBM",	"MCM",	"MFS",	"MGP",	"MLM",	"MOT",	"MUM",	"OES",	"ORA",	"P35",	"P40",	"P93",	"P98",	"PAM",	"PSM",	"SES",	"SHL",	"SHM",	"SLM",	"SPB",	"SPV",	"SSO",	"STM",	"ZTU",	"ZWU")
